class RecreateCurrentSchema < ActiveRecord::Migration[7.0]
  def change
    remove_foreign_key :accepted_challenges, :challenges
    remove_foreign_key :accepted_challenges, :users
    ...
    remove_foreign_key :approvals, :accepted_challenges
    remove_foreign_key :approvals, :users
    remove_foreign_key :challenges, :games
    remove_foreign_key :challenges, :users
    remove_foreign_key :comments, :comments, column: :parent_id
    remove_foreign_key :difficulties, :challenges
    remove_foreign_key :difficulties, :users
